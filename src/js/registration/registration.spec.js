describe("A registration service that", function () {
  ...
  describe("function to calcluate due dates for payment", function(){
    it("should return a date 30 days before class", function() {
      ...
      expect((registrationService._calcDueDate(classDate.getTime(), 30, 5))).toEqual('2016-09-15');
    });
    it("should return a date 30 days before class when given an ISO date", function() {
      ...
      expect(registrationService._calcDueDate('2016-10-15', 30, 5)).toEqual('2016-09-15');
    });
    it("should return a date 5 days from today", function() {
      ...
      expect(registrationService._calcDueDate(classDate.getTime(), 30, 5)).toEqual('2016-08-06');
    });
    it("should return class date", function() {
      ...
      expect(registrationService._calcDueDate(classDate.getTime(), 30, 5)).toEqual('2016-08-03');
    });
    it("should return todays date", function() {
      ...
      expect(registrationService._calcDueDate(classDate.getTime(), 30, 5)).toEqual('2016-08-01');
    });
  });
